...
export class SchemaInit1594466159622 implements MigrationInterface {
    name = 'SchemaInit1594466159622'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "week" ("id" SERIAL NOT NULL, "number" integer NOT NULL, "year" integer NOT NULL, CONSTRAINT "PK_1f85dfadd5f363a1d0bce2b9664" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "viewport" ("id" SERIAL NOT NULL, "share" numeric(5,2) NOT NULL, "platformId" integer, "regionId" integer, "displayId" integer, "weekId" integer, CONSTRAINT "UQ_VIEWPORT" UNIQUE ("displayId", "platformId", "regionId"), CONSTRAINT "PK_7e8b09deafe11c008e826637551" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "viewport" ADD CONSTRAINT "FK_d04c65dac918d3cbe1bf7b57d18" FOREIGN KEY ("weekId") REFERENCES "week"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "viewport" DROP CONSTRAINT "FK_d04c65dac918d3cbe1bf7b57d18"`);
