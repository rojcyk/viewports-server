...
export class SchemaInit1594323619722 implements MigrationInterface {
    name = 'SchemaInit1594323619722'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "viewport" ("id" SERIAL NOT NULL, "share" numeric(5,2) NOT NULL, "platformId" integer, "regionId" integer, "displayId" integer, CONSTRAINT "UQ_VIEWPORT" UNIQUE ("displayId", "platformId", "regionId"), CONSTRAINT "PK_7e8b09deafe11c008e826637551" PRIMARY KEY ("id"))`);
